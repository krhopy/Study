...
// 	● 문제) 표준편차(Standard deviation) 구하기
		...
		/*		
			1) avar의 평균(87.2)를 구하고, aver의 각 요소에서 87.2를 뻰다 = (85+90+93+86+82)/5 
		 	   85-87.2= -2.2	aver의 aver - aver[i]
		 	   90-87.2=	 2.8
		 	   93-87.2=	 5.8
		 	   86-87.2=	-1.2
		 	   82-87.2=	-5.2
		 	   
		 	2) 1)의 값을 전부 양수로 바꾼다. 편차 Math.abs? 
		 	   2.2
		 	   2.8
		 	   5.8
		 	   1.2
